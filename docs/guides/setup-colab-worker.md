...
/content/venv/bin/python infra/stacks/worker/colab/colab_runner.py start \
  --skip-install \
...
```bash
/content/venv/bin/python infra/stacks/worker/colab/colab_runner.py status
/content/venv/bin/python infra/stacks/worker/colab/colab_runner.py logs --tail 80
/content/venv/bin/python infra/stacks/worker/colab/colab_runner.py stop
```
...
`infra/stacks/worker/colab/colab_runner.py` with Colab-visible logs.
