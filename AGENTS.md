...
- `cli` 사용: `cli e2e local [core|mlflow]`, `cli local up|down|ps|logs`, `cli storage up|down|ps|logs`, `cli worker fixed <up|down|ps|logs|build>`, `cli prefect <action> [--remote]`.
